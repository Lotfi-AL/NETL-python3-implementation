...
input_dump = "dump/dumpfile.xml.bz2" # The path to your Wikipedia XML dump.
...
loc_parser = "support_packages/stanford-parser-full-2020-11-17" # Directory for stanford parser.  Download it.
...
epochs_word2vec =20 #Ideal number of epochs for word2vecmodel. If you want the model to be trained quicker reduce the epochs.
