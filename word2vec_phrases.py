...
#Gobals
title_length = 6 # Length of wikipedia title you want to filter. All titles greter than or equal to this value will be thrown away
...
output_filename = 'training/additional_files/word2vec_phrases_list_tokenized.txt'  # The name of output file you want the list of valid wikipedia titles to be saved into. Will be a pickle file
loc_parser = "training/support_packages/stanford-parser-full-2020-11-17" # Directory of stanford Parser.
...
y_parallel = [get_labels(file_name) for file_name in filenames_temp]
